export const ZH_TEXTS = {
    ...
    ingestStatusAnalyzing: '提取中… 分析中',
    lintStatusReading: '维护中… 读取 ({current}/{total})',
    lintStatusDuplicates: '维护中… 重复 ({current}/{total})',
    lintStatusScanningLinks: '维护中… 扫描链接',
    lintStatusAnalyzing: '维护中… AI分析',
